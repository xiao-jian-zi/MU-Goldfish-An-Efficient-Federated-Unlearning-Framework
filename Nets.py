# -*- coding: utf-8 -*-
"""
Created on Wed Nov  8 22:59:48 2023
...
def args_parser():
    ...
    parser.add_argument('--delete_round', type=int, default=9, help="truncated rounds")
    parser.add_argument('--new_epoch', type=int, default=10, help="new epoch")
    parser.add_argument('--delete_data_ratio', type=float, default=0.05, help="the ratio of delete data")
...
class MLP(nn.Module):
    def __init__(self, img_size,args,dim_hidden=200):
        ...
        self.layer_hidden = nn.Linear(dim_hidden, args.num_classes)
